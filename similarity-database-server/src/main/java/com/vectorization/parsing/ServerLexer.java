...
public class ServerLexer extends Lexer {
    ...
    public enum SSType implements Type {
        NUMBER, NEGNUMBER, NAME, STAR, COMMA, DOT, EQUALS, LBRACK, RBRACK, EOF_TYPE
    }
    ...
    private Token consumeNegNumber() {
        StringBuilder sb = new StringBuilder();
        while (isDigit() || isNeg()) {
            sb.append(getLookAhead());
            consume();
        ...
        return new Token(SSType.NEGNUMBER, sbString);
    }
